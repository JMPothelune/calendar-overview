<script lang="ts">
  ...
  function toogleCalendarWindow() {
    $calendarSettingsStore.showWindow = !$calendarSettingsStore.showWindow;
  }
</script>


<section class="flex flex-col space-y-12">
  {#if $calendarSettingsStore.showWindow}
  ...
  <section>
    <SlideToggle bind:checked={$calendarSettingsStore.alwaysVisible}>Toujours visible</SlideToggle>
  </section>
  ...
  <section class="flex flex-row items-center space-x-4">
    ...
    <SlideToggle bind:checked={$calendarSettingsStore.isLightMode}></SlideToggle>
